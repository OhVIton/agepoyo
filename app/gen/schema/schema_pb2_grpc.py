...
class AgepoyoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.converse = channel.unary_unary(
                ...
                request_serializer=schema_dot_schema__pb2.ConversationRequest.SerializeToString,
                response_deserializer=schema_dot_schema__pb2.ConversationResponse.FromString,
...
def add_AgepoyoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'converse': grpc.unary_unary_rpc_method_handler(
                    servicer.converse,
                    request_deserializer=schema_dot_schema__pb2.ConversationRequest.FromString,
                    response_serializer=schema_dot_schema__pb2.ConversationResponse.SerializeToString,
            ),
...
class AgepoyoService(object):
    ...
    def converse(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/agepoyo.AgepoyoService/converse',
            schema_dot_schema__pb2.ConversationRequest.SerializeToString,
            schema_dot_schema__pb2.ConversationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
